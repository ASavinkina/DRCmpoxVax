...
cases_plot <- ggplot(data=data_cases_long2, aes(y=cases_averted,  x=Vax_Province, fill=Vax_Province)) + geom_bar(stat="identity", show.legend = FALSE) +
  ...
  facet_wrap(~VaxStrategy, ncol=3) + theme_classic() + theme(axis.text.x = element_text(angle = 70,  hjust=1), text=element_text(size=20),strip.text = element_text(
    size = 13))
...
vaccinations_plot <- ggplot(data=data_vaccinations_long2, aes(y=vaccinations/1000000,  x=Vax_Province, fill=Vax_Province)) + geom_bar(stat="identity", show.legend = FALSE) +
  facet_wrap(~VaxStrategy, ncol=3) + theme_classic() +xlab("") + ylab("Number vaccine doses, millions") + theme(axis.text.x = element_text(angle = 70,  hjust=1), text=element_text(size=20),strip.text = element_text(
    size = 13))
...
vaccinations_HR_plot <- ggplot(data=data_HR_vaccinations_long2, aes(y=vaccinations/1000,  x=Vax_Province, fill=age)) + geom_bar(stat="identity") +
  facet_wrap(~VaxStrategy, ncol=3) + theme_classic() +xlab("") + ylab("Number vaccine doses, thousands") + theme(axis.text.x = element_text(angle = 70,  hjust=1), text=element_text(size=20),strip.text = element_text(
    size = 9)) +
  scale_fill_discrete(labels=c('High risk adult', 'Low risk adult','Child 5-15','Child under 5')) +
  labs(fill="Vaccine doses by age, millions")
...
pdf(file = "results/Figure2_Cases_Averted_3424.pdf",   # The directory you want to save the file in
...
pdf(file = "results/Figure4_Vaccine_Doses_3424.pdf",   # The directory you want to save the file in
    width = 12, # The width of the plot in inches
    height = 12) # The height of the plot in inches
...
pdf(file = "results/Figure3_Deaths_Averted_3424.pdf",   # The directory you want to save the file in
    width = 12, # The width of the plot in inches
    height = 12) # The height of the plot in inches
...
pdf(file = "results/SupplementalFigure1_Cases_Averted_100pVax_3424.pdf",   # The directory you want to save the file in
    width = 12, # The width of the plot in inches
    height = 12) # The height of the plot in inches
...
pdf(file = "results/SupplementalFigure3_Vaccine_Doses_100pVax_3424.pdf",   # The directory you want to save the file in
    width = 12, # The width of the plot in inches
    height = 12) # The height of the plot in inches
...
pdf(file = "results/SupplementalFigure2_Deaths_Averted_100pVax_3424.pdf",   # The directory you want to save the file in
    width = 12, # The width of the plot in inches
    height = 12) # The height of the plot in inches
...
pdf(file = "results/SupplementalFigure4_Cases_Averted_HRVax_3424.pdf",   # The directory you want to save the file in
    width = 12, # The width of the plot in inches
    height = 12) # The height of the plot in inches
...
pdf(file = "results/SupplementalFigure6_Vaccine_Doses_HRVax_3424.pdf",   # The directory you want to save the file in
    width = 12, # The width of the plot in inches
    height = 12) # The height of the plot in inches
...
pdf(file = "results/SupplementalFigure5_Deaths_Averted_HRVax_3424.pdf",   # The directory you want to save the file in
    width = 12, # The width of the plot in inches
    height = 12) # The height of the plot in inches
