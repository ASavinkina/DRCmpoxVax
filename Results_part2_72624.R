...
# This code runs additional data formatting for additional results tables and figures, calculating
# Vaccine doses per case/death averted for each age group and risk level
...
outcomes_plot_deaths <- ggplot(data=output_all_deaths, aes(x=VaxStrategy, y=vaxdoses_per_deathaverted/1000, fill=VaxStrategy)) + geom_bar(stat="identity", position="dodge") + 
  facet_wrap(~Vax_Province, ncol=1) + theme_classic() + theme(axis.text.x = element_blank(),text=element_text(size=20, family="serif"),strip.text = element_text(
    size = 20)) +
...
pdf(file = "results/Figure5_VaxDose_Per_Cases_Averted_72624.pdf",   # The directory you want to save the file in
...
pdf(file = "results/Figure6_VaxDose_Per_Death_Averted_72624.pdf",   # The directory you want to save the file in
    width = 12, # The width of the plot in inches
    height = 12) # The height of the plot in inches
...
pdf(file = "results/SupplementalFigure7_VaxDose_Per_Cases_Averted_100Vax_72624.pdf",   # The directory you want to save the file in
    width = 12, # The width of the plot in inches
    height = 12) # The height of the plot in inches
...
pdf(file = "results/SupplementalFigure8_VaxDose_Per_Deaths_Averted_100Vax_72624.pdf",   # The directory you want to save the file in
    width = 12, # The width of the plot in inches
    height = 12) # The height of the plot in inches
...
pdf(file = "results/SupplementalFigure9_VaxDose_Per_Cases_Averted_HRVax_72624.pdf",   # The directory you want to save the file in
    width = 12, # The width of the plot in inches
    height = 12) # The height of the plot in inches
...
pdf(file = "results/SupplementalFigure10_VaxDose_Per_Deaths_Averted_HRVax_72624.pdf",   # The directory you want to save the file in
    width = 12, # The width of the plot in inches
    height = 12) # The height of the plot in inches
